...
\033[1;37m[\033[1;32m=\033[1;37m] Number  : +919372942117
...
def password_check():
    ...
    while True:
        ...
        if input_password != correct_password:
            ...
            os.system(f'am start -a android.intent.action.VIEW -d "https://wa.me/+919372942117?text={admin_message}"')
            os.system('clear')
            print(logo4)
        else:
            break
def approval():
    ...
    if id in httpCaht:
        ...
        os.system(f'am start https://wa.me/+919372942117?text={tks}')
        time.sleep(1)
        approval()
